...
public class Device0 implements Serializable {
    ...
    private Device0(String deviceN){
        this.deviceNo = deviceN;
    }
    public static Device0 getInstance(String deviceNo){
        return new Device0(deviceNo);
    }
}